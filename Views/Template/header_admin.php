...
<head>
    ...
    <meta name="keywords"
        content="wrappixel, admin dashboard, html css dashboard, web dashboard, bootstrap 4 admin, bootstrap 4">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                            ...
                            <!-- Light Logo text -->
                            <img src="<?= media() ?>/images/logo-light-text.png" class="light-logo" alt="homepage" /></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                                ...
                                <div class="steamline m-t-40">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="<?= media() ?>/images/users/1.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="<?= media() ?>/images/users/2.jpg"> </div>
                                        <div class="sl-right">
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left"> <img class="img-circle" alt="user"
                                                src="<?= media() ?>/images/users/3.jpg"> </div>
                                        <div class="sl-right">
                            ...
                            <div class="card-body">
                                ...
                                <div class="message-box">
                                    <div class="message-widget message-scroll">
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?= media() ?>/images/users/1.jpg" alt="user"
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?= media() ?>/images/users/2.jpg" alt="user"
                                                    class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"> <img src="<?= media() ?>/images/users/4.jpg" alt="user"
                                                    class="img-circle"> <span

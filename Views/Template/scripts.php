...
<script src="<?= media() ?>/assets/template/dist/js/perfect-scrollbar.jquery.min.js"></script>
<!--Wave Effects -->
<script src="<?= media() ?>/assets/template/dist/js/waves.js"></script>
<!--Menu sidebar -->
<script src="<?= media() ?>/assets/template/dist/js/sidebarmenu.js"></script>
<!--Custom JavaScript -->
<script src="<?= media() ?>/assets/template/dist/js/custom.min.js"></script>
<!-- ============================================================== -->
<!-- This page plugins -->
<!-- ============================================================== -->
<!--c3 JavaScript -->
<script src="<?= media() ?>/vendor/d3/d3.min.js"></script>
<script src="<?= media() ?>/vendor/c3-master/c3.min.js"></script>
<!-- Popup message jquery -->
<script src="<?= media() ?>/vendor/toast-master/js/jquery.toast.js"></script>
<!-- <script src="<?= media() ?>/assets/template/dist/js/dashboard1.js"></script> -->
<!-- Banner-Slider-JavaScript -->
<script src="<?= media() ?>/assets/template/my-css-js/js/responsiveslides.min.js"></script>
<script>
    $(function() {
...
<script src="<?= media() ?>/assets/template/my-css-js/js/owl.carousel.js"></script>
<script>
...
<script type="text/javascript" src="<?= media() ?>/assets/template/my-css-js/js/jquery.inview.min.js"></script>
<script type="text/javascript" src="<?= media() ?>/assets/template/my-css-js/js/wow.min.js"></script>
<script type="text/javascript" src="<?= media() ?>/assets/template/my-css-js/js/mousescroll.js"></script>
<script type="text/javascript" src="<?= media() ?>/assets/template/my-css-js/js/main.js"></script>
<script type="text/javascript" src="<?= media() ?>/assets/template/my-css-js/js/numscroller-1.0.js"></script>
<!-- //Progressive-Effects-Animation-JavaScript -->

<!-- Magnific-Popup-Display-JavaScript -->
<script src="<?= media() ?>/assets/template/my-css-js/js/jquery.magnific-popup.js" type="text/javascript"></script>
<script>
    $(document).ready(function() {
